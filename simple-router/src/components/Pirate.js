...
// Pirate looks up the pirate using the number parsed from the URL's pathname. 
// If no pirate is found with the given number, then a "pirate not found" message is displayed.
const Pirate = (props) => {
